...
var LightRange=function(){this.savedSelection};
...
document.selection.createRange(),e=document.documentElement.scrollTop,f=document.documentElement.scrollLeft,a.width=b.boundingWidth,a.height=b.boundingHeight,a.xStart=b.boundingLeft+f,a.yStart=b.boundingTop+e,a.text=b.text,b.collapse(!1),a.xEnd=b.boundingLeft+f,a.yEnd=b.boundingTop+e;else return null;a.characters=a.text.replace(/\s/g,"").length;a.charactersAll=a.text.replace(/[\n\r]/g,"").length;return a};
LightRange.prototype.saveSelection=function(){if(window.getSelection){var a=window.getSelection();a.getRangeAt&&a.rangeCount&&(this.savedSelection=a.getRangeAt(0))}else if(document.selection&&document.selection.createRange)this.savedSelection=document.selection.createRange();else return null;return this.savedSelection};
LightRange.prototype.restoreSelection=function(){if(this.savedSelection)if(window.getSelection){var a=window.getSelection();a.removeAllRanges();a.addRange(this.savedSelection)}else if(document.selection&&this.savedSelection.select)this.savedSelection.select();else return null;return this.savedSelection};var lightrange=new LightRange;
