...
function lightrange() {
  ...
  // IE 8 and below.
    ...
    data.xStart = range.boundingLeft;
    data.yStart = range.boundingTop;

    data.text = range.text;

    // startOffset and endOffset for IE 8 and below are not natively supported and are not so easily to implement.
    ...
    data.xEnd = range.boundingLeft;
    data.yEnd = range.boundingTop;
  }
